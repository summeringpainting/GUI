...
def BeastEasy(counter=0, counter1=1, luckvar=3, countup=2, level=1):
    print("You are on LVL " + str(level) + "! To win EASY pick a number between 1 to " + str(luckvar) + " in " + str(
        countup) + " guesses")
...
def BeastMedium(counter=0, counter1=1, luckvar=3, countup=2, level=1):
    print("You are on LVL " + str(level) + "! To win MEDIUM pick a number between 1 to " + str(luckvar) + " in " + str(
        countup) + " guesses")
    luck = random.randint(1, luckvar)
    print("The answer will be " + str(luck))
    loto = (int(input("Pick a number from 1 to " + str(luckvar) + ": ")))
...
def BeastHard(counter=0, counter1=1, luckvar=3, countup=2, level=1):
    print("You are on LVL " + str(level) + "! To win HARD pick a number between 1 to " + str(luckvar) + " in " + str(
        countup) + " guesses")
    luck = random.randint(1, luckvar)
    print("The answer will be " + str(luck))
    loto = (int(input("Pick a number from 1 to " + str(luckvar) + ": ")))
